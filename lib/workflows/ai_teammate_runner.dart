/// AI Teammate Runner
/// Contains the core logic for running the AI teammate workflow
library;
...
/// Run the AI teammate workflow for a given ticket
Future<void> runAiTeammate(String ticketKey) async {
